...
// TIME UTILITIES
//Dana - cant compile on linux 07-03-2019
//void printTime(ostream& out);

// TEXT UTILITIES
string int2string(const int i);
string double2string(const double x, const size_t howManyDigitsAfterTheDot=5, bool round = false);
...
bool fromStringIterToSize_t(string::const_iterator & it,
	const string::const_iterator endOfString,
	size_t& res);
